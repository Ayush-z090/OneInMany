                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed max-w-lg">
                                The main stage of market research allows for a popular rating, relying on insider information. Production meaningfully inhibits interpersonal repeated contact. According to Philip Kotler's already classic work, market price analysis is based on experience.
                            </p>
                        </div>
                    </div>
                </div>
