...
const Footer = () => {
  ...
  return (
    <AnimatePresence>
      ...
      layout
      key={"comp_8"}
      {...slideFade(time,is_E8,delayArr[7])}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <img src={nikeLogo} alt="Nike Logo" className="h-8 mb-4" />
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Nike App</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Nike Run Club</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Nike Training Club</a></li>
              </ul>
            </div>
